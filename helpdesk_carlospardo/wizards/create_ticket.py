...
class CreateTicket(models.TransientModel):
    ...
    def create_ticket(self):
        ...
        action = self.env["ir.actions.actions"]._for_xml_id("helpdesk_carlospardo.helpdesk_ticket_action_all")
        action['views'] = [(self.env.ref('helpdesk_carlospardo.view_helpdesk_ticket_form').id, 'form')]
